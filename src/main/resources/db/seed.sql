...
SELECT 1, 'Avatar 1', '/assets/avatars/avatar-1.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 1);

INSERT INTO avatars (id, name, image_url)
SELECT 2, 'Avatar 2', '/assets/avatars/avatar-2.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 2);

INSERT INTO avatars (id, name, image_url)
SELECT 3, 'Avatar 3', '/assets/avatars/avatar-3.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 3);

INSERT INTO avatars (id, name, image_url)
SELECT 4, 'Avatar 4', '/assets/avatars/avatar-4.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 4);

INSERT INTO avatars (id, name, image_url)
SELECT 5, 'Avatar 5', '/assets/avatars/avatar-5.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 5);

INSERT INTO avatars (id, name, image_url)
SELECT 6, 'Avatar 6', '/assets/avatars/avatar-6.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 6);

INSERT INTO avatars (id, name, image_url)
SELECT 7, 'Avatar 7', '/assets/avatars/avatar-7.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 7);

INSERT INTO avatars (id, name, image_url)
SELECT 8, 'Avatar 8', '/assets/avatars/avatar-8.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 8);

INSERT INTO avatars (id, name, image_url)
SELECT 9, 'Avatar 9', '/assets/avatars/avatar-9.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 9);

INSERT INTO avatars (id, name, image_url)
SELECT 10, 'Avatar 10', '/assets/avatars/avatar-10.webp'
WHERE NOT EXISTS (SELECT 1 FROM avatars WHERE id = 10);

INSERT INTO avatars (id, name, image_url)
SELECT 11, 'Avatar 11', '/assets/avatars/avatar-11.webp'
